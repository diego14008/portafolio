...
<body class="account-register col-2">
  ...
  <div class="container">
    <ul class="breadcrumb">
      ...
      <li><a href="registrarse">Registrarme</a></li>
    </ul>
    <div class="row">
      <?php include_once 'include/nav_cuenta.php'; ?>
      <div class="col-sm-9" id="content">
        <h1>Registrar cuenta</h1>
        <p>Si ya tiene una cuenta, inicie sesión <a href="login">Aquí</a>.</p>
        <form id="form_cuenta" class="form-horizontal" enctype="multipart/form-data" method="post" action="register">
          <fieldset id="account">
            ...
            <div class="form-group required">
              <label for="input-firstname" class="col-sm-2 control-label">Nombres</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input-firstname" placeholder="Nombres" required name="nombres">
              </div>
            </div>
            <div class="form-group required">
              <label for="input-lastname" class="col-sm-2 control-label">Apellidos</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input-lastname" placeholder="Apellidos" required name="apellidos">
              </div>
            </div>
            <div class="form-group required">
              <label for="input-lastname" class="col-sm-2 control-label">DNI</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input-lastname" placeholder="DNI" required name="dni">
              </div>
            </div>
            <div class="form-group required">
              <label for="input-email" class="col-sm-2 control-label">E-Mail</label>
              <div class="col-sm-10">
                <input type="email" class="form-control" id="input-email" placeholder="E-Mail" required name="email">
              </div>
            </div>
            <div class="form-group required">
              <label for="input-telephone" class="col-sm-2 control-label">Teléfono</label>
              <div class="col-sm-10">
                <input type="tel" class="form-control" id="input-telephone" placeholder="Teléfono" required name="telefono">
              </div>
            </div>
          </fieldset>
          <fieldset id="address">
            ...
            <div class="form-group required">
              <label for="input-address-1" class="col-sm-2 control-label">Dirección 1</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input-address-1" placeholder="Dirección 1" required name="address_1">
              </div>
            </div>
            <div class="form-group">
              <label for="input-address-2" class="col-sm-2 control-label">Dirección 2</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input-address-2" placeholder="Dirección 2" value="" name="address_2">
              </div>
            </div>
            <div class="form-group required">
              <label for="input-city" class="col-sm-2 control-label">Cuidad</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="input-city" placeholder="Ciudad" value="" name="city">
              </div>
            </div>
            <!-- <div class="form-group required">
          ...
          <fieldset>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-10">
                <input type="password" class="form-control" id="input-password" placeholder="" required name="password">
              </div>
            </div>
            <div class="form-group required">
              <label for="input-confirm" class="col-sm-2 control-label">Confirmar contraseña</label>
              <div class="col-sm-10">
                <input type="password" class="form-control" id="input-confirm" placeholder="" required name="password_confirm">
              </div>
            </div>
          </fieldset>
          <!-- <fieldset>
