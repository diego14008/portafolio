...
<div class="footer-bottom">
  <div class="container">
    <div class="copyright">Powered By&nbsp;<a class="yourstore" href="#">Social Marketing Online &copy; 2020 </a> </div>
    <div class="footer-bottom-cms">
      <div class="footer-payment">
        <ul>
          <li class="mastero">
            <a href="#"><img alt="" src="image/mastero.jpg"></a>
          </li>
          <li class="visa">
            <a href="#"><img alt="" src="image/visa.jpg"></a>
          </li>
          <li class="currus">
            <a href="#"><img alt="" src="image/currus.jpg"></a>
          </li>
          <li class="discover">
            <a href="#"><img alt="" src="image/discover.jpg"></a>
          </li>
          <li class="bank">
            <a href="#"><img alt="" src="image/bank.jpg"></a>
          </li>
        </ul>
      </div>
    </div>
